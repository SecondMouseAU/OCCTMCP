...
canonical 70-tool surface documented here; the **Node** server exposes a 37-tool subset — each tool
...
| [Mesh analysis (zones)](mesh-analysis.md) | segment_mesh_zones, zone_continuity_sweep, list_zones, clear_zones, mesh_diagnose, mesh_thickness, detect_symmetry |
