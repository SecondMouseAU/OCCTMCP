...
| [Mesh analysis (zones)](mesh-analysis.md) | segment_mesh_zones, zone_continuity_sweep, list_zones, clear_zones, mesh_diagnose, mesh_thickness, detect_symmetry, align_bodies, fit_primitives |
