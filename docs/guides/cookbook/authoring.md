...
<model-viewer src="models/authoring.glb" poster="images/authoring.png" alt="A drilled block" camera-controls auto-rotate environment-image="neutral" exposure="1.1" shadow-intensity="1" style="width:100%;max-width:480px;height:360px;background:#eef1f5;border-radius:6px"></model-viewer>
