...
The Node server exposes a 37-tool subset; the Swift server exposes all 70 tools (selection, remap,
annotations, reconstruction, mesh-zone analysis, mesh inspection, and more are Swift-only). See the
