...
description: OCCTMCP products — OCCTMCPCore library, occtmcp-server executable, and the 77-tool catalogue.
...
## MCP tool catalogue (77 typed tools)
...
mesh analysis (zones, alignment, curvature, mesh features), selection & remap, annotations &
overlays, I/O, visualisation, topology graph, and the reconstruction graph tool group).
